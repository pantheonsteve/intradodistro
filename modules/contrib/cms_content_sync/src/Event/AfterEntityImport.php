...
/**
 * The entity has been imported successfully.
 * Other modules can use this to react on successful import events.
 */
class AfterEntityImport extends Event {

  const EVENT_NAME = 'cms_content_sync.entity.import.after';
